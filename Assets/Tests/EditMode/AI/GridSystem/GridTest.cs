...
namespace Tests.EditMode.AI.GridSystem
{
    public class GridTest
    {
        ...
        public void GetGridPosition_Width10Height8_AtX0Y0_ReturnsWorldPos()
        {
            ...
            var (x, y) = grid.GetGridPosition(new Vector2(0, 0));
            Assert.AreEqual(0, x);
            Assert.AreEqual(0,y);
        }
        ...
        public void GetGridPosition_Width10Height8_AtXMin0Dot1Y0Dot1_ReturnsGridPos()
        {
            ...
            var (x, y) = grid.GetGridPosition(new Vector2(4.5f, 5.5f));
            Assert.AreEqual(4, x);
            Assert.AreEqual(5, y);
        }
        ...
        public void GetGridPosition_XOutOfBoundsMin_ReturnsNullish()
        {
            ...
            var (x, y) = grid.GetGridPosition(new Vector2(-0.1f, 1f));
            Assert.AreEqual(-1, x);
            Assert.AreEqual(-1, y);
        }
        ...
        public void GetGridPosition_XOutOfBoundsMax_ReturnsNullish()
        {
            ...
            var (x, y) = grid.GetGridPosition(new Vector2(5.1f, 1f));
            Assert.AreEqual(x, -1);
            Assert.AreEqual(y, -1);
        }
        ...
        public void GetGridPosition_YOutOfBoundsMin_ReturnsNullish()
        {
            ...
            var (x, y) = grid.GetGridPosition(new Vector2(1f, -0.1f));
            Assert.AreEqual(x, -1);
            Assert.AreEqual(y, -1);
        }
        ...
        public void GetGridPosition_YOutOfBoundsMax_ReturnsNullish()
        {
            ...
            var (x, y) = grid.GetGridPosition(new Vector2(1f, 7.1f));
            Assert.AreEqual(x, -1);
            Assert.AreEqual(y, -1);
        }
        ...
        {
            var grid = new Grid<GridNode>(5, 7, (g, gx, gy) => new GridNode(gx, gy), 1f, new Vector2(2, -2));

            var (x, y) = grid.GetGridPosition(new Vector2(3f, -2f));
            Assert.AreEqual(x, 1);
            Assert.AreEqual(y, 0);
        }
